...
object WioChannels {
    ...
    val all: List<WioChannel> = listOf(
        ...
        // 🔵 Mavi Spor (S Sport 1..2 & S Sport Plus 1..5)
        ...
        WioChannel("mavi_plus_3", "🔵 Mavi Spor Plus 3", GROUP_MAVI, "S Sport Plus 3", listOf("ssportplus3", "splus3", "s+3", "mavi plus 3", "s sport plus 3"), "${BASE_LOGO}mavi_plus_3.png"),
        WioChannel("mavi_plus_4", "🔵 Mavi Spor Plus 4", GROUP_MAVI, "S Sport Plus 4", listOf("ssportplus4", "splus4", "s+4", "mavi plus 4", "s sport plus 4"), "${BASE_LOGO}mavi_plus_4.png"),
        WioChannel("mavi_plus_5", "🔵 Mavi Spor Plus 5", GROUP_MAVI, "S Sport Plus 5", listOf("ssportplus5", "splus5", "s+5", "mavi plus 5", "s sport plus 5"), "${BASE_LOGO}mavi_plus_5.png"),
